...
//	window = glfwCreateWindow(1024, 768, "Particles in Gravity", NULL, NULL);
//	if (window == NULL) {
...
//
//		float speed = 500.0f * pow((rand() % 10000) / 10000.0f, 0.3);
...
//		);
//
//		ParticlesContainer[particleIndex].speed = randomdir;
//
//
...
//						glm::vec3 gravity = glm::vec3(0.0f, -9.81f * 50, 0.0f); // Gravity acceleration
//						glm::vec3 friction = (float)(-0.02f * startSpeedValue / p.size) * startSpeed; // Friction acceleration, f=kSv^2, where we set k=0.01
